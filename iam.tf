...
resource "aws_iam_instance_profile" "porch-node" {
  name = "terraform-eks-demo"
  role = "${aws_iam_role.kube-node.name}"
}

resource "aws_iam_role_policy_attachment" "porch-AmazonEKSClusterPolicy" {
  policy_arn = "arn:aws:iam::aws:policy/AmazonEKSClusterPolicy"
  role       = "${aws_iam_role.kube-cluster.name}"
}

resource "aws_iam_role_policy_attachment" "porch-AmazonEKSServicePolicy" {
